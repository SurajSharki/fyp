  ...
  return (
    <div className="aboutus-bg">
      <div className="container">
        <h1 className="display-4 text-center mb-5">About SportQuest</h1>
        ...
        <section className="mb-5">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <img src={about} width="400" height="300" alt="Our Mission" className="img-fluid rounded shadow" />
            </div>
          </div>
        </section>
        ...
        <section className="mb-5">
          ...
          <div className="row">
            <div className="col-md-6 order-md-2">
              <img src={cycling} width="400" height="300" alt="Best Academies" className="img-fluid rounded shadow" />
            </div>
        ...
        <section className="mb-5">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <img src={coach} width="400" height="300" alt="Elite Coaches" className="img-fluid rounded shadow" />
            </div>
          </div>
        </section>
        ...
        <section className="bg-white p-4 rounded shadow mb-5">
          ...
          <div className="row">
            <div className="col-md-4 text-center">
              <img src={coach} width="200" height="200" alt="John Doe" className="img-fluid rounded-circle shadow" />
            </div>
        ...
        <section>
          ...
          <div className="row">
            <div className="col-md-6 order-md-2">
              <img src={sport} width="400" height="300" alt="Sports Journey" className="img-fluid rounded shadow" />
            </div>
            <div className="col-md-6 order-md-1">
              <p className="text-muted">
