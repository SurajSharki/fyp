  ...
  const addDetails = async () => {
    try {
      ...
      const response = await axios.put(
        `http://localhost:8000/addAcademyProfile/${academyId}`,
        formDate
      );
                ...
                >
                  <div className="academy-form-group mb-2">
                    ...
                    <input
                      ...
                      value={
                        academyInfo.name !== undefined
                          ? academyInfo.name
                          : academyData?.name || ""
                      }
                      onChange={(e) =>
                        setAcademyInfo({ ...academyInfo, name: e.target.value })
                      }
                    />
                  </div>
                  <div className="academy-form-group">
                    ...
                    <input
                      className="academy-form-control"
                      value={
                        academyInfo.ownerName !== undefined
                          ? academyInfo.ownerName
                          : academyData?.ownerName || ""
                      }
                      onChange={(e) => {
                        setAcademyInfo({
                          ...academyInfo,
                  ...
                  <div className="academy-form-group">
                    ...
                    <input
                      className="academy-form-control"
                      value={
                        academyInfo.contactNumber !== undefined
                          ? academyInfo.contactNumber
                          : academyData?.contactNumber || ""
                      }
                      onChange={(e) =>
                        setAcademyInfo({
                          ...academyInfo,
          ...
          <div className="academy-right-col">
            <div className="academy-card">
              <div className="academy-card-body">
                ...
                <h3 className="academy-title mt-3">
                  Academy Name:{" "}
                  {academyInfo.name !== undefined
                    ? academyInfo.name
                    : academyData?.name || ""}
                </h3>
                <p className="academy-location fw-bold text-center">
